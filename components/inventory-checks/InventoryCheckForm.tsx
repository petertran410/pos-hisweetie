...
export function InventoryCheckForm({ onClose }: Props) {
  ...
  return (
    <div className="border rounded-xl bg-white m-4 flex flex-col overflow-hidden">
      {/* Header */}
      <div className="flex items-center justify-between px-4 py-3 border-b">
        <h2 className="text-base font-semibold">Tạo phiếu kiểm hàng loại B</h2>
                  ...
                  return (
                    <tr key={item.productId} className="border-t">
                      ...
                      <td
                        ...
                        {isOverflow ? "Vượt quá!" : goodStock.toLocaleString()}
                      </td>
