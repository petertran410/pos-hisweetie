...
> = {
  ...
  "/khach-hang/demand-oem": { resource: "customer_demand", action: "view" },
  "/khach-hang/hop-dong": { resource: "contracts", action: "view" },
  "/khach-hang/theo-doi-cong-no": { resource: "debt_tracking", action: "view" },
...
key: "transfer-planning",
      ...
      },
      {
        ...
        href: "/san-pham/pha-che",
        permission: { resource: "recipes", action: "view" },
      },
      {
        key: "destructions",
        label: "Xuất hủy",
      ...
      {
        key: "purchasing-planning",
        label: "Dự kiến đặt hàng",
        href: "/san-pham/du-kien-dat-hang",
        permission: { resource: "purchasing_planning", action: "view" },
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      {
        key: "customer-demand",
        label: "Demand khách hàng (OEM/đặt hộ)",
        href: "/khach-hang/demand-oem",
        permission: { resource: "customer_demand", action: "view" },
      },
      {
        key: "contracts",
        label: "Hợp đồng",
        href: "/khach-hang/hop-dong",
        permission: { resource: "contracts", action: "view" },
      },
      {
        key: "debt-tracking",
        label: "Theo dõi công nợ",
        href: "/khach-hang/theo-doi-cong-no",
        permission: { resource: "debt_tracking", action: "view" },
      },
    ],
  },
  {
